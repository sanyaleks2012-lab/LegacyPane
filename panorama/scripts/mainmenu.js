...
var MainMenu = ( function() {
	...
	var _SetBackgroundMovie = function()
	{
		...
		var imageBg = $( '#MainMenuBGImage' );

		if ( !( videoPlayer && videoPlayer.IsValid() ) )
			return;

		// Show static background image, hide video
		videoPlayer.SetHasClass('hidden', true);
		imageBg.SetHasClass('hidden', false);
		imageBg.SetImage( "file://{resources}/backgrounds/background_16x9.png" );

		// Keep vanity lighting working
	...
	{
		// DISABLED: Stream, News, Store, LimitedTest, LastMatch, WatchNotice
	};
